...
<head>
  <meta charset="UTF-8">
  <title>Agregar Veterinario - Veterinaria Ralah Pets</title>
...
<div class="card">
  <h2>⚕️ Agregar Veterinario</h2>
  <form action="index.php?entidad=veterinario&accion=guardarNuevo" method="POST">
    <div class="mb-3">
    ...
    <div class="mb-3">
      ...
      <input type="text" name="especialidad" id="especialidad" class="form-control" 
             placeholder="Medicina General, Cirugía, etc." required>
    </div>

    <div class="mb-3">
      <label for="correo" class="form-label">Correo Electrónico</label>
      <input type="email" name="correo" id="correo" class="form-control" 
             placeholder="ejemplo@veterinaria.com" required>
    </div>
